  ...
  getDepositInfoForUpi() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (result.code == "1") {
        ...
        bankName.value = result.userData.first.bankName;
        bankAddress.value = result.userData.first.bankAddress;
        accountNo.value = result.userData.first.accountNo;
        name.value = result.userData.first.fullName;
