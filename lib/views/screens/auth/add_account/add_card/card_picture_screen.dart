            ...
            () => Column(
              children: [
                _cardUpload(
                    ...
                    "   Upload a picture of the front side of your card, please make sure the name printed on the card should be clearly visible and should match the name on your profile.\n\n\n",
                    'You can hide the expiration date but the card numbers should be clearly readable and visible.',
            ...
            () => Column(
              children: [
                _cardUpload4(
                  ...
                  "  Please upload the most recent credit card or bank statement linked to the card. Please be advised the statement should not be older than 2 months and it should have all the necessary information of your card and billing details.\n\n\n",
                  null,
