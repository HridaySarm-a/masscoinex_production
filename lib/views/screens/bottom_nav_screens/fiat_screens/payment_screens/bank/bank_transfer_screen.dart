...
class BankTransferScreen extends StatelessWidget {
  final _controller = Get.put(BankPaymentController());
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Obx(() => _controller.userDataList.length != 0
                ? _bankDropdown()
                : SizedBox()),
            SizedBox(
              height: 2.h,
  ...
  Widget _bankNames(String initText, RxString text) {
    return Text(
      "$initText: ${text.value}",
      style: TextStyle(
