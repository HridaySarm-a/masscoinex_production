...
class AddBankScreenNewLogicForce extends StatefulWidget {
  AddBankScreenNewLogicForce({Key? key}) : super(key: key);

  @override
  State<AddBankScreenNewLogicForce> createState() =>
      _AddBankScreenNewLogicForceState();
}

class _AddBankScreenNewLogicForceState
    extends State<AddBankScreenNewLogicForce> {
  ...
  BankCodeResponse bankCodeResponse = BankCodeResponse();
  ...
  _addBank() async {
    ...
    if (_response.statusCode == 200) {
      ...
      Get.offAllNamed(Routes.verifyKycNewLogic);
    } else {
      _isUpdated.value = true;
      Fluttertoast.showToast(
