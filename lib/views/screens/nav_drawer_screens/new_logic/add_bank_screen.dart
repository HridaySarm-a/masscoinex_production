...
class AddBankScreenNewLogic extends StatefulWidget {
  AddBankScreenNewLogic({Key? key}) : super(key: key);

  @override
  State<AddBankScreenNewLogic> createState() => _AddBankScreenNewLogicState();
}

class _AddBankScreenNewLogicState extends State<AddBankScreenNewLogic> {
