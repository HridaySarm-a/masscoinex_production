...
class CurrencySelectNewLogic extends StatelessWidget {
  final _selectCountryController = Get.put(CurrencySelectControllerNewLogic());
  CurrencySelectNewLogic({Key? key}) : super(key: key);
